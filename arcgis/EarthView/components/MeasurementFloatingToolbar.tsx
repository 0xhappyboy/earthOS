...
import { DeleteIcon, CloseIcon, DragHandleIcon } from "../../icons";
import { Translations } from "../../i18n";

interface MeasurementFloatingToolbarProps {
  visible: boolean;
...
export const MeasurementFloatingToolbar: React.FC<MeasurementFloatingToolbarProps> = ({
  visible,
  position,
  onPositionChange,
  onDelete,
  ...
  return (
    ...
    >
      <div
        ...
        onMouseEnter={(e) => {
          if (!isDragging) e.currentTarget.style.background = isDark ? "#4d4d4d" : "#ddd";
        }}
        onMouseLeave={(e) => {
          if (!isDragging) e.currentTarget.style.background = isDark ? "#3d3d3d" : "#e8e8e8";
        }}
      >
